...
%channel: intra-array array [x] <-> array [x+1]
\end{kappasource}
...
%channel: intra-circle circle [x] <-> circle [x+1]
%channel: intra-circle circle [n-1] <-> circle [0] # Replace n-1 as above
\end{kappasource}
...
%channel: intra-mesh mesh [x][y] <-> mesh [x+1][y] 
%channel: intra-mesh mesh [x][y] <-> mesh [x][y+1] 
%channel: intra-mesh mesh [x][y] <-> mesh [x+1][y+1] 
%channel: intra-mesh mesh [x][y] <-> mesh [x+1][y-1] 
\end{kappasource}
...
%channel: intra-mesh mesh [x][y] <-> mesh [x][y+1] 
%channel: intra-mesh mesh [x][y] <-> mesh [x+1][y] 
%channel: intra-mesh mesh [x][y] <-> mesh [x+1][(y+1)-(2*(x%2))] 
...
%channel: intra-mesh mesh [x][m-1] <-> mesh [x+1][0] # Replace m-1 as above 

# add this to get a torus
%channel: intra-mesh mesh [n-1][y] <-> mesh [0][y] # Replace n-1 as above 
\end{kappasource}
